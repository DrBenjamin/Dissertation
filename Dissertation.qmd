...
: @tab-training-2class-1: Confusion matrix for 2-class training 1 showing class imbalance and preference for `non-normal posture`.
...
: @tab-training-row-2class-1: Row-normalized confusion matrix for 2-class training 1 showing class imbalance and preference for `non-normal posture`.
...
: @tab-report-training-2class-1: Classification results for 2-class training 1 showing an accuracy of 60%, but on a highly imbalanced class distribution.
...
: @tab-training-2class-2: Confusion matrix for 2-class training 2 showing class imbalance and preference for `normal posture`.
...
: @tab-training-row-2class-2: Row-normalized confusion matrix for 2-class training 2 showing class imbalance and preference for `normal posture`.
...
: @tab-report-training-2class-2: Classification results for 2-class training 2 showing an accuracy of 53.16%.
...
: @tab-training-2class-3: Confusion matrix for 2-class training 3 showing class imbalance and preference for `normal posture`.
...
: @tab-training-row-2class-3: Row-normalized confusion matrix for 2-class training 3 showing class imbalance and preference for `normal posture`.
...
: @tab-report-training-2class-3: Classification results for 2-class training 3 showing an accuracy of 55.85%.
...
: @tab-training-3class-1: Confusion matrix for 3-class training 1 showing slight over-prediction of `slumped` class.
...
: @tab-training-row-3class-1: Row-normalized confusion matrix for 3-class training 1 showing slight over-prediction of `slumped` class.
...
: @tab-report-training-3class-1: Classification results for 3-class training 1 showing an accuracy of 30.65% and a balanced accuracy of 31.11%.
...
: @tab-training-3class-2: Confusion matrix for 3-class training 2 showing under-representation of `normal posture` class and a preference for `slumped posture`.
...
: @tab-training-row-3class-2: Row-normalized confusion matrix for 3-class training 2 showing under-representation of `normal posture` class and a preference for `slumped posture`.
...
: @tab-report-training-3class-2: Classification results for 3-class training 2 showing an accuracy of 32.16% and a balanced accuracy of 32.63%.
...
: @tab-training-3class-3: Confusion matrix for 3-class training 3 showing preference for `slumped posture` class.
...
: @tab-training-row-3class-3: Row-normalized confusion matrix for 3-class training 3 showing preference for `slumped posture` class.
...
: @tab-report-training-3class-3: Classification results for 3-class training 3 showing an accuracy of 39.20% and a balanced accuracy of 39.79%.
...
: @tab-training-3class-4: Confusion matrix for 3-class training 4 showing preference for `slumped posture` class.
...
: @tab-training-row-3class-4: Row-normalized confusion matrix for 3-class training 4 showing preference for `slumped posture` class.
...
: @tab-report-training-3class-4: Classification results for 3-class training 4 showing an accuracy of 41.21% and a balanced accuracy of 41.67%.
