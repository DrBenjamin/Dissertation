...
The dataset and splits used across all runs were consistent. The training set contained 300 original images distributed across two or three classes. For all but the first 2-class training, the number from 300 original images were increased to \~1500 to \~1800.
...
![2-Class - Training 1 confusion matrix showing low amount of test images and preference for category \`non-normal posture\`.](literature/Results/Training_2-class_1.png){#fig-training-2class-1}
...
![2-Class - Training 2 confusion matrix showing \`normal posture\` class preference.](literature/Results/Training_2-class_2.png){#fig-training-2class-2}
...
![2-Class - Training 3 confusion matrix again showing \`normal posture\` class preference.](literature/Results/Training_2-class_3.png){#fig-training-2class-3}
...
![3-Class - Training 1 confusion matrix showing under-representation of \`tensed posture\` class.](literature/Results/Training_3-class_1.png){#fig-training-3class-1}
...
![3-Class - Training 2 confusion matrix showing under-representation of \`normal posture\` class and a preference for \`slumped posture\`.](literature/Results/Training_3-class_2.png){#fig-training-3class-2}
...
![3-Class - Training 3 confusion matrix showing preference of \`slumped posture\` class.](literature/Results/Training_3-class_3.png){#fig-training-3class-3}
...
![3-Class - Training 4 confusion matrix showing again preference of \`slumped posture\` class.](literature/Results/Training_3-class_4.png){#fig-training-3class-4}
