...
**CI/CD:** Jenkins webhook for heavy builds and notebook images - Jenkins is used for build a Jupyter environment on a server to run model training and it also builds an Streamlit Webapp for inference testing of (build) models:
...
**CI/CD:** GitHub Actions for Quarto artifacts

\- A GitHub Actions workflow (run manully) renders the dissertation via Quarto:
...
| True  Pred | normal | slumped | tensed |
|------------|-------:|--------:|-------:|
| normal     |      4 |      38 |     21 |
| slumped    |      2 |      40 |     20 |
| tensed     |      3 |      51 |     20 |
