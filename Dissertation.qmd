...
Also, I received guidance and support from my two supervisor, Ahmar Shar and John Wilson, who gave me many recommendations during the whole process to conduct the project as well reviewedthe draft of the paper once and gave me valuable feedback.
...
- **noise:** Several OpenCV image processing routines where applied to multiply the origial 300 images to changed duplicates. Techniques used are:
...
- **overlay:** With a preexisting Google MediaPipe Pose detection model that creates a mesh of 33 body landmark overlay points, colors for good vs. bad posture (white/red), the 300 original images were processed to be real copies plus the overlays.
...
![3-Class - Training 1](literature/Results/Training_4.png){alt="3-Class - Training 4"}
