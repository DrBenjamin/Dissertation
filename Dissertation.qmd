...
![Move AI advertising accurate markerless motion capturing on their website.](literature/Media/Move%20AI.png){#fig-move-ai fig-align="right"}
...
![3 types of posture types defined by Klein-Vogelbach, the underlying functional movement concept was developed between 1955-1975.](literature/Media/3_posture_types.png){#fig-klein-vogelbach-posture}
...
![Streamlit Web App with classification of postures using the build quantized model from Training 4 (3-class) @fig-training-3class-4.](docs/Streamlit_WebApp.png){#fig-streamlit-app}
...
![Implementation map illustrates the pipelines, automation and containerization.](docs/CNN%20Workflow.drawio.png){#fig-CNN-workflow}
...
::: {#tbl-training-row-2class-1}
| True $\backslash$ Predicted | non-normal | normal |
|----------------------------:|-----------:|-------:|
|                  non-normal |     0.6667 | 0.3333 |
|                      normal |     0.6667 | 0.3333 |

: Row-normalized confusion matrix for 2-class training 1 showing class imbalance and preference for `non-normal posture`.
:::
...
![Confusion matrix showing low amount of test images and preference for category \`non-normal posture\`.](literature/Results/Training_2-class_1.png){#fig-training-2class-1}
...
::: {#tbl-training-row-2class-2}
| True $\backslash$ Predicted | non-normal | normal |
|----------------------------:|-----------:|-------:|
|                  non-normal |     0.4268 | 0.5732 |
|                      normal |     0.3553 | 0.6447 |

Row-normalized confusion matrix for 2-class training 2 showing class imbalance and preference for `normal posture`.
:::
...
![Confusion matrix showing \`normal posture\` class preference.](literature/Results/Training_2-class_2.png){#fig-training-2class-2}
...
::: {#tbl-training-row-2class-3}
| True $\backslash$ Predicted | non-normal | normal |
|----------------------------:|-----------:|-------:|
|                  non-normal |     0.4835 | 0.5165 |
|                      normal |     0.3711 | 0.6289 |

Row-normalized confusion matrix for 2-class training 3 showing class imbalance and preference for `normal posture`.
:::
...
![Confusion matrix again showing \`normal posture\` class preference.](literature/Results/Training_2-class_3.png){#fig-training-2class-3}
...
Row-normalized confusion matrix for 3-class training 1 showing slight over-prediction of `slumped` class.
:::
...
![Confusion matrix showing under-representation of \`tensed posture\` class.](literature/Results/Training_3-class_1.png){#fig-training-3class-1}
...
Row-normalized confusion matrix for 3-class training 2 showing under-representation of `normal posture` class and a preference for `slumped posture`.
:::
...
![Confusion matrix showing under-representation of \`normal posture\` class and a preference for \`slumped posture\`.](literature/Results/Training_3-class_2.png){#fig-training-3class-2}
...
Row-normalized confusion matrix for 3-class training 3 showing preference for `slumped posture` class.
:::
...
![Confusion matrix showing preference of \`slumped posture\` class.](literature/Results/Training_3-class_3.png){#fig-training-3class-3}
...
Row-normalized confusion matrix for 3-class training 4 showing preference for `slumped posture` class.
:::
...
![Confusion matrix showing again preference of \`slumped posture\` class.](literature/Results/Training_3-class_4.png){#fig-training-3class-4}
...
@fig-training-2class-1

@fig-training-2class-2

@fig-training-2class-3

@fig-training-3class-1

@fig-training-3class-2

@fig-training-3class-3

@fig-training-3class-4
