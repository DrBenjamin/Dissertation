...
To utilize the existing MediaPipe Pose model to create images with the YOLO 33 body landmarker overlay, for testing purposes an Interface was developed. Herefore Streamlit, an open-source Python framework was choosen to build a graphical user interface at `code/mediapipe_pose.py`.

Streamlit is widely used in the data science sphere, to build interactive data apps. The same Interface was used to test the build classification models, as you can see in the following presentation:
...
This illustration shows the whole implementation setup and dependencies:

![Implementation illustration](docs/CNN%20Workflow.drawio.png)
