...
![3 types of posture types by Klein-Vogelbach](literature/Media/3_posture_types.png){#fig-klein-vogelbach-posture}
...
![Streamlit Web App with classification of postures using the build quantized model from Training 4 (3-class)](docs/Streamlit_WebApp.png) {#fig-streamlit-app}
...
The @CNN-workflow illustration shows the whole implementation setup and dependencies.

![Implementation illustration](docs/CNN%20Workflow.drawio.png){#fig-CNN-workflow}
...
![2-Class - Training 1](literature/Results/Training_2-class_1.png){#fig-training-2class-1}
...
![2-Class - Training 2](literature/Results/Training_2-class_2.png){#fig-training-2class-2}
...
![2-Class - Training 3](literature/Results/Training_2-class_3.png){#fig-training-2class-3}
...
![3-Class - Training 1](literature/Results/Training_3-class_1.png){#fig-training-3class-1}
...
![3-Class - Training 2](literature/Results/Training_3-class_2.png){#fig-training-3class-2}
...
![3-Class - Training 3](literature/Results/Training_3-class_3.png){#fig-training-3class-3}
...
![3-Class - Training 4](literature/Results/Training_3-class_4.png){#fig-training-3class-4}

### Error analysis

Across all experiments a consistent pattern of misclassification is apparent. The models show relatively high recall for the `slumped posture` class but lower precision, indicating a tendency to predict `slumped` for a wide range of inputs as you can see in @fig-training-3class-3. `Normal posture` is frequently misclassified (low recall in several runs), and `tensed posture` predictions vary by architecture: deeper Lite variants tended to improve overall discrimination.
