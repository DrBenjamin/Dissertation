...
Chapter 4 details the implementation of the training and inference pipelines with a complex CD/CI integration.

Chapter 5 presents the results of model performance and error analysis and shows the challenges of training a custom CNN model.
...
- **Hardware and runtime**
  ...
  The development was mostly performed on a remote virtual machine with 8GB RAM and 4 CPU Cores. For editing Python scripts, a Jupyter Notebook was used, for editing the Quarto project file a RStudio Server. Next to this, a Streamlit WebApp was developed and used to test re-trained models manually. Both the Jupyter notebook and the Streamlit WebApp were deployed via a Docker container on the remote server to manage heavy Python library dependencies of MediaPipe Model Maker (Python 3.10) respective of MediaPipe / TensorFlow Lite (Python 3.13).

- **Representative software stack**

  - Python 3.10 (Model Maker) or Python 3.13 (Inference)
  - TensorFlow 2.19.1 with TFLite support and Keras (3.12.1)
  - MediaPipe (0.10.20) and MediaPipe Model Maker (0.2.1.3)
  - OpenCV, NumPy, pandas, Matplotlib
  - Jupyter notebook
  - Quarto (for rendering `Dissertation.qmd`) on RStudio Server
...
![Implementation infrastructure](docs/CNN Workflow.drawio.png)
...
The best-performing model achieved an accuracy of 41%. To improve performance and enhance clinical interpretability, the task will also be reformulated as a binary classification problem (normal vs. non-normal posture) using the same labeled and annotated image dataset. The objective is to reach an accuracy of approximately 80–90%, which is generally considered strong performance for practical detection tasks in applied machine learning settings and for the Google MediaPipe model architecture.

### Model performance - 2-class problem

The same base dataset was used for both experiments. To address class imbalance, data augmentation was applied with an 8× multiplication for normal posture images and a 4× multiplication for non-normal posture images, resulting in a balanced dataset of 1,580 synthetically augmented images.

Two training runs were conducted. The first used the full augmented dataset of 1,580 images. The second extended this dataset by an additional 300 images, which were augmented using body landmark overlays generated with the Google MediaPipe Pose framework to incorporate explicit skeletal structure information.

#### Training 2-class problem 1

Model architecture: EFFICIENTNET_LITE4
Training batch size: 16
Epoch number: 80
Model file: [/Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_094018/model.tflite](https://file+.vscode-resource.vscode-cdn.net/Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_094018/model.tflite)
Quantized model (int8) file: [/Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_094018/model_int8.tflite](https://file+.vscode-resource.vscode-cdn.net/Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_094018/model_int8.tflite)
Train split class counts (total=1264):
non-normal posture: 664
normal posture: 600

Validation split class counts (total=158):
non-normal posture: 74
normal posture: 84

Test split class counts (total=158):
...
\
![Training 1](literature/Results/Traning_2-class_1.png)

#### Training 2-class problem 2 **(extra body landmark overlay image-set)**
...
Model file: /Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_104831/model.tflite

Quantized model (int8) file: /Users/ben/Python/Streamlit/Dissertation/data/models/efficientnet_lite4/20260504_104831/model_int8.tflite

Train split class counts (total=1804):

non-normal posture: 1034

normal posture: 770

Validation split class counts (total=188):

non-normal posture: 103

normal posture: 85

Test split class counts (total=188):
...
![](literature/Results/Training_2-class_2.png)
...
# Ethics, Information Governance, and Data Management
