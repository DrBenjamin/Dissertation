...
![Streamlit Web App with classification of postures using the build quantized model from Training 4 (@tbl-training-row-3class-4).](docs/Streamlit_WebApp.png){#fig-streamlit-app}
...
Future improvements should focus on targeted data collection at class boundaries, multi-rater annotation protocols, posture-aware augmentation strategies, probability calibration and threshold optimisation to achieve clinically meaningful sensitivity and specificity.Translated with DeepL.com (free version)
