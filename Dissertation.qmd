...
![Move AI advertising accurate markerless motion capturing on their website.](literature/Media/Move AI.png){#fig-move-ai fig-align="right"}
...
Training execution - Training can be run locally via the hosted Jupyter notbook on `custom_image_classifier_model_training.ipynb`.
